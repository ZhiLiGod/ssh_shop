...
<div class="container productList">
	...
	<form id="productForm" action="${pageContext.request.contextPath}/image/" method="get">
		<div id="result" class="result table clearfix">
				<ul>
					<s:iterator value="pb.list" var="pb">
					<li>
						<a href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="#pb.pid" />">
							<img src="${pageContext.request.contextPath}/<s:property value="#pb.image" />" width="170" height="170"  style="display: inline-block;" />									   
							<span style='color:green'>
							 	<s:property value="#pb.pname" />
							</span>
							 
							<span class="price">
								Price: €<s:property value="#pb.shop_price" />
							</span>
		...
		<div class="pagination">
			...
			<s:if test="cid != null">
				<s:if test="pb.page != 1">
					...
					<a class="previousPage" href="${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="cid" />&page=<s:property value="pb.page-1" /> ">&nbsp;</a>
				</s:if>	
				...
				<s:if test="pb.page != pb.totalPage">
					<a class="nextPage" href="${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="cid" />&page=<s:property value="pb.page+1" /> ">&nbsp;</a>			
					<a class="lastPage" href="${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="cid" />&page=<s:property value="pb.totalPage" /> ">&nbsp;</a>
				</s:if>
			</s:if>
			<s:if test="csid!=null">
				<s:if test="pb.page != 1">
					<a class="firstPage" href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid" />&page=1">&nbsp;</a>
					<a class="previousPage" href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid" />&page=<s:property value="pb.page-1" /> ">&nbsp;</a>
				</s:if>	
				<s:iterator begin="1" end="pb.totalPage" var="i">
					<s:if test="pb.page != #i">	
				...
				<s:if test="pb.page != pb.totalPage">
					<a class="nextPage" href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid" />&page=<s:property value="pb.page+1" /> ">&nbsp;</a>			
					<a class="lastPage" href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid" />&page=<s:property value="pb.totalPage" /> ">&nbsp;</a>
				</s:if>
			</s:if>
		</div>
		</form>
