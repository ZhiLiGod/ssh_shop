...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/title.jpg" alt="Real" title="Real" height="50" width="320" />
</div>	</div>
	<%@ include file="menu.jsp" %>
		...
		<div class="span18 last">
			...
			<div class="sn">
				<div>ID:<s:property value="model.pid" /></div>
			</div>
			<div class="info">
				<dl>
					<dt>Price:</dt>
					...
					<dl>
						<dt>Big Deal:</dt>
						<dd>
								<a target="_blank" title="Flash Sale(2017-05-31 ~ 2017-06-30)">Flash Sale</a>
						</dd>
					</dl>
					<dl>
						<dt>    </dt>
			...
			<form id="cartForm" action="${pageContext.request.contextPath}/cart_addCart.action" method="post" >
				...
				<div class="action">
					...
					<div class="buy">
							<input id="addCart" class="addCart" value="Add to Cart" type="button" onclick="addToCart()" />
					</div>
				</div>	
			</form>
