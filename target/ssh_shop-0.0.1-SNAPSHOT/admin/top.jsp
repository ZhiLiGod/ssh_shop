		...
		<table width="100%" height="70%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<!-- <td>
				 ...
				 -->
				<td width="100%" background="${pageContext.request.contextPath}/images/os.jpg">
				</td>
			</tr>
		</table>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											User：
											<font color="blue"><s:property value="#session.eu.username"/></font>
										</td>
										<td width="18" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											<a href="${pageContext.request.contextPath}/adminUser_logout.action" target="_parent">Logout</a>
