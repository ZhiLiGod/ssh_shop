			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<input type="text" name="cname" value="<s:property value="model.cname"/>" onclick="edit()" id="userAction_save_do_logonName" class="bg"/>
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<button type="submit" id="userAction_save_do_submit" value="Confirm" class="button_ok">
							&#30830;&#23450;
						</button>
